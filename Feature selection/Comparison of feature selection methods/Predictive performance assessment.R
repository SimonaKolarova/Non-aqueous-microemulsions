...
model_performance_assessment <- function(training_data, testing_data, validation_data, predictors, model_performance, model, model_name, model_number) {
  ...
  model_performance$Fscore_validation[model_number] <- as.numeric(confusion_matrix_validation[[4]]["F1"])
